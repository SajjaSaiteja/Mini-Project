...
#TAKE VIDEO---------------------------------------------------------------------
video = cv2.VideoCapture('videoinput.mp4')
...
fps  = 8 #TO COMPENSATE FOR SLOW PROCESSING
...
speedLimit=int(input('Enter the OverSpeed Limit'))
print('The Speed Limit Set at ',speedLimit,'kmph')
...
def estimateSpeed(carID):
    ...
    speed = round(markGap/timeDiff*fps*3.6,2)
    return speed
